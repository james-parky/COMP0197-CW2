...
def main():
    ...
    model.load_model()
    model.change_classification(37)
    # model.freeze_layers()
    # model.train()
    # model.load_model()
    model.test()
...
# TODO:
# - Refactor to take dataset as option and adjust data object accordingly.
# - Change data object to be general.
# - Update so that load and save filenames are taken as parameter.
